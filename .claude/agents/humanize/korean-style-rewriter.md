...
3. **흔한 어휘 우선(plain-language)**: 번역투를 걷어내려다 잘 안 쓰는 문어체·문학체 어휘로 갈아타지 않는다. drift→평이 대응표(`quick-rules.md` "흔한 어휘 우선")를 적용. 원문에 없던 비유·수사 추가 금지. 반대 방향인 **구어 은유·영어 관용구 직역**(`칸을 먹다`, `걸려 넘어지는 지점`, `되는 길`)도 같은 위반이라 원문에 있으면 평이한 서술어로 바꾼다(`quick-rules.md` 둘째 대응표, 2026-09-22).
