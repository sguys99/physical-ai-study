...
# %% [markdown]
# # W2-M1 실습 3 — compounding error: 상한이 아니라 실측으로
#
# [`../lesson.md`](../lesson.md) `§3.2`(왜 $T^2$인가) · `§3.3`(chunking이 상한을 어떻게 바꾸는가)의
...
# | ③ receding horizon | 100 | 10 또는 50 | §3.6 2·3행 |
#
# 출력:
# - stdout — 3종 비교표 + $k$ 스윕 ASCII U자 곡선
...
# %% [markdown]
# ## 1. 오차 모델 — $\epsilon_k$를 어떤 형태로 잡았고 왜 그런가
#
