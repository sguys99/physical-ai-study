...
> 🚧 **데드락 방지선 상태 — 해소.** W1 모듈 **3/5** 확보(M1·M2·M5). §7의 "주차 시작 시 최소 3개" 기준 충족. **끝까지 지킬 것(§8) 중 FSQ 구현(W1-M5)도 완료.**
> 남은 W1: W1-M3(DDPM, Tier C) · W1-M4(Flow Matching, Tier C) — 둘 다 강점 압축 구간이라 상대적으로 빠르게 진행 가능.
