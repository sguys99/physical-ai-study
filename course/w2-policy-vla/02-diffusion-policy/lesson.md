...
| 마무리 | 오해, 한 장 정리, 퀴즈 10문항, 실습 안내 | 백지 재구성으로 자기 점검하기 | 13분 |
...
- 앞 모듈 ACT의 실측 51,613,582개와 비교하면 약 **5.1배**이고, 체크포인트 파일 하나가 **1,003 MB**입니다(ACT는 592 MB).
...
- **체크포인트 하나가 1,003 MB입니다.** `--save_freq`를 기본값 20,000보다 줄이면 디스크가 빠르게 찹니다.
