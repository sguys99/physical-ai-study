...
여기서 만든 인스턴스 위에서 **W2 LeRobot, W3 보행 학습, W4 내비게이션 스택이 전부 돕니다.** 그래서 이 모듈에만 1.5일이 배정돼 있습니다.
...
**이 랩의 마지막 명령입니다.** 논문 읽는 시간·워크시트 채우는 시간에 GPU를 켜두는 것이 4주 예산에서 가장 큰 낭비 항목입니다 (deep-dive §7).
