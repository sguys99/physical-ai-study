...
| 트랙 | 완료 | 비고 |
|---|---|---|
| W1 모듈 (생성모델 코어) | 0 / 5 | **W1-M1 · W1-M2 · W1-M5 ★ 집필 4종 완료**, 학습자 실행검증만 남음 · **W1-M3 집필 3종 완료**(lesson.md + practice/ + labs/), 윤문만 남음 |
| W2 모듈 (정책·VLA) | 0 / 5 | — |
| W3 모듈 (WBC·RL) | 0 / 5 | — |
| W4 모듈 (월드모델·내비·통합) | 0 / 5 | — |
| 논문노트 3-pass | 1 / 6 | **FSQ 완료** · SONIC · HOMIE · pi0 · DP · DualMap |
| 리포 투어 | 0 / 4 | OpenHomie · SONIC · unitree_rl_gym · DualMap |
| 용어집 (목표 100개) | 0 / 4주차 | 주차 종료 시 25개씩 · 현재 **40개**(기본 10 + W1-M1 10 + W1-M2 10 + W1-M5 10) |
| 팀 질문 | — | 17건 적립 (P0 5 + W1-M1 6 + W1-M2 5 + W1-M5 6, 중복 제외) |
| 캡스톤 | 0 / 1 | 스택 해설 문서 + 발표 |
